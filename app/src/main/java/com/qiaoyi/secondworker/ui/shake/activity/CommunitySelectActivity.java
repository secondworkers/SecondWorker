...
public class CommunitySelectActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String city_code = "370100";
    ...
    private void requestData() {
        ApiUserService.selectShequ(city_code, "", new ServiceCallBack<WrapCommunityBean>() {
            @Override
                ...
                rv_list.addOnItemTouchListener(new OnItemClickListener() {
                    ...
                    public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                        ...
                        TextView tv_name = view.findViewById(R.id.tv_name);
                            new SelectCommunityDialog(CommunitySelectActivity.this, new SelectCommunityDialog.DoneClickListener() {
                                @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_search:
                ...
                intent1.putExtra("city_code",city_code);
