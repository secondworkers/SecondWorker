package com.qiaoyi.secondworker.view.datepicker;
...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        //被选中的数字颜色
        mPaint.setColor(ContextCompat.getColor(context, R.color.deep_black));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        //未选中的数字颜色
        nPaint.setColor(ContextCompat.getColor(context, R.color.text_grey));
    }
