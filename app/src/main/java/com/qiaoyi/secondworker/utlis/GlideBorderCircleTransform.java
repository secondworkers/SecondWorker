...
public class GlideBorderCircleTransform extends BitmapTransformation {
  ...
  public GlideBorderCircleTransform(Context context, int borderColor){
    this(context,4,borderColor);
  }

  public GlideBorderCircleTransform(Context context, int borderWidth, int borderColor) {
